        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Preco = table.Column<decimal>(maxLength: 50, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Cidade = table.Column<string>(maxLength: 10, nullable: false),
                    EndereCompleto = table.Column<string>(maxLength: 50, nullable: false),
